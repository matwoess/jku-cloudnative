...
kubectl -n argocd patch secret argocd-secret -p '{"stringData": {"admin.password": "$2a$10$Xs.v9QC19GVkEkV7ZmXx1e/TowW.4CVqyp0m74XolCOOIvyaEJOvi","admin.passwordMtime": "'$(date +%FT%T%Z)'"}}'
